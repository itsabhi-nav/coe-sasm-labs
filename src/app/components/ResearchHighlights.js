...
const researchItems = [
  {
    ...
    icon: (
      <FaSatelliteDish className="text-indigo-500 text-4xl group-hover:scale-110 transition-transform duration-300" />
    ),
  },
  {
    ...
    icon: (
      <FaFlask className="text-purple-500 text-4xl group-hover:scale-110 transition-transform duration-300" />
    ),
  },
  {
    ...
    icon: (
      <FaProjectDiagram className="text-pink-500 text-4xl group-hover:scale-110 transition-transform duration-300" />
    ),
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {researchItems.map((item, index) => (
            <motion.div
              key={index}
              className="group p-6 rounded-2xl backdrop-blur-md shadow-2xl transition-all duration-300 border hover:shadow-[0_0_20px_var(--accent)] flex flex-col items-center text-center"
              style={{
